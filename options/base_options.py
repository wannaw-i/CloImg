...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--name', type=str, default='sketch2img',
        ...
        # for setting inputs
        # 这个参数设置数据集路径，路径下面存在这四个子文件夹
        self.parser.add_argument('--dataroot', type=str, default='./datasets/mydata/')
        ...
        self.parser.add_argument('--no_instance', default=True, action='store_true',
